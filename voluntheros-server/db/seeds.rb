...
task10 = Task.create(title: 'Walks', elderly_id: elderly3.id)
task10 = Task.create(title: 'Other', details: 'take out trash', elderly_id: elderly6.id)
task10 = Task.create(title: 'Other', details: 'moving', elderly_id: elderly1.id)
task10 = Task.create(title: 'Other', details: 'general cleaning', elderly_id: elderly2.id)